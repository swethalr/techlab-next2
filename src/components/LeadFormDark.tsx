  ...
  return (
      ...
      <div className="container mx-auto max-w-5xl px-6">
        <div className="text-center mb-12">
          <h3 className="h3 text-white mb-4 tracking-tight">
            Looking for More Traffic & Leads?
          </h3>
          <p className="text-white p max-w-2xl mx-auto">
            We have helped 38 top brands in the world and 250+ local brands for the last 20+ years.
          </p>
        </div>

        <div className="bg-emerald-900/60 rounded-[2rem] p-8 md:p-12 shadow-2xl">
