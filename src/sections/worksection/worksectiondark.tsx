...
// --- DATA IMPORT ---
import { results, workSectionContent } from '@/data/work-section/work-section-dark';
...
export default function WorkSectiondark() {
  return (
    <section className="relative overflow-hidden bg-black py-12 md:py-24">
      ...
      <div className="container relative z-10 mx-auto px-4">
        ...
        <div className="mb-10 text-center md:mb-16">
          ...
          <h3 className="h3 font-bold leading-tight text-white">
